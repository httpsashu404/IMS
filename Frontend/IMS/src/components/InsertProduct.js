...
export default function InsertProduct() {
    ...
    return (
        <div className='container bg-light p-3 m-5 rounded'>
            <div className="row">
                <div className="col">
                    <form className="form">
                        ...
                        <div className="mt-5 col-lg-6 col-md-6 col-12">
                            ...
                            <input type="text" onChange={setName} value={productName} className="form-control form-control-sm" id="product_name" placeholder="Enter Product Name" required autoFocus />
                        </div>
                        <div className="mt-3 col-lg-6 col-md-6 col-12">
                            <label htmlFor="product_price" className="form-label fw-bold">Product Price : </label>
                            <input type="number" onChange={setPrice} value={productPrice} className="form-control form-control-sm" id="product_price" placeholder="Enter Product Price" required />
                        </div>
                        <div className="mt-3 mb-5 col-lg-6 col-md-6 col-12">
                            ...
                            <input type="number" onChange={setBarcode} value={productBarcode} maxLength={12} className="form-control form-control-sm" id="product_barcode" placeholder="Enter Product Barcode" required />
                        </div>
