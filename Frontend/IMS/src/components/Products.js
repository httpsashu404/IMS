...
export default function Products() {
    ...
    return (
        <>
            ...
            <div className='container bg-light m-5 p-5 rounded'>
                <h1>Products Inventory</h1>
                <div className='add_button'>
                    <NavLink to="/insertproduct" className='btn btn-primary'> + Add New Product</NavLink>
                </div>
                                    ...
                                    return (
                                        <>
                                            <tr>
                                                ...
                                                <td><NavLink to={`/updateproduct/${element._id}`} className="btn btn-success"><i className="fa-solid fa-pen-to-square"></i></NavLink></td>
